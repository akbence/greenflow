...
public class CorsResponseFilter implements ContainerResponseFilter {
    ...
    public final static String DEFAULT_ALLOWED_HEADERS = "origin,accept,content-type,authorization,set-cookie";
    public final static String DEFAULT_EXPOSED_HEADERS = "location,info";

    @Override
    public void filter(ContainerRequestContext requestContext, ContainerResponseContext responseContext) throws IOException {
        final MultivaluedMap<String, Object> headers = responseContext.getHeaders();
        headers.add("Access-Control-Allow-Origin", "https://10.0.0.188:4200");
